...
//-------------------------高斯积分点的权重-----------------------------------
double *getGaussQuadratureWeights(int NumberOfGaussPoints)
{
	double *GaussWeights = new double[NumberOfGaussPoints];
...
//-------------------------高斯积分点的坐标-----------------------------------
double *getGaussQuadratureCoordinates(int NumberOfGaussPoints)
{
	double *GaussPoints = new double[NumberOfGaussPoints];
	switch (NumberOfGaussPoints)
	{
	case  1:
